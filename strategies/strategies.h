...
private:
    ...
    bool optimizeSingular(Matrix &, std::vector<std::pair<unsigned short int, unsigned short int>> const &) const;

    bool optimizeUnique(Matrix &, std::vector<std::pair<unsigned short int, unsigned short int>> const &) const;
